...
import { Upload, Play, Shield, ScrollText, TimerReset, Sparkles, MoveRight, Home, BookText, Film, Trophy, Database, Send, Mail, Github, Twitter } from 'lucide-react'
...
function FloatingShapes() {
  ...
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(1200px_400px_at_50%_-10%,rgba(236,72,153,0.08),transparent),radial-gradient(900px_300px_at_10%_20%,rgba(20,184,166,0.08),transparent),radial-gradient(1100px_400px_at_90%_10%,rgba(244,63,94,0.06),transparent)]" />

      <motion.div
        className="absolute -left-10 top-24 h-28 w-28 rounded-full bg-pink-500/20 ring-2 ring-pink-500/50 shadow-[0_0_80px_rgba(236,72,153,0.35)] hidden sm:block"
        animate={{ y: [0, -20, 0], x: [0, 10, 0] }}
        transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
      />
      <motion.div
        className="absolute right-8 top-36 h-24 w-24 bg-teal-400/20 ring-2 ring-teal-400/60 shadow-[0_0_80px_rgba(20,184,166,0.35)] hidden sm:block"
        style={{ clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)' }}
        animate={{ y: [0, 25, 0], rotate: [0, 10, -5, 0] }}
        transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut' }}
      />
      <motion.div
        className="absolute left-1/2 bottom-10 h-20 w-20 -translate-x-1/2 bg-fuchsia-500/10 ring-2 ring-fuchsia-400/60 shadow-[0_0_80px_rgba(244,63,94,0.35)] sm:block"
        animate={{ y: [0, -15, 0], scale: [1, 1.05, 1] }}
        transition={{ duration: 7, repeat: Infinity, ease: 'easeInOut' }}
      />

      {/* soft shafts of light */}
      <div className="absolute left-10 top-0 h-full w-24 rotate-6 bg-gradient-to-b from-pink-500/10 via-transparent to-transparent blur-2xl hidden sm:block" />
      <div className="absolute right-12 top-0 h-full w-24 -rotate-6 bg-gradient-to-b from-teal-400/10 via-transparent to-transparent blur-2xl hidden sm:block" />

      {/* tiny hover-bright Easter eggs */}
      <div className="absolute bottom-24 left-6 h-3 w-3 rounded-full bg-pink-500/20 ring-1 ring-pink-400/40 transition-all duration-300 hover:bg-pink-400 hover:shadow-[0_0_12px_rgba(236,72,153,0.8)]" />
      <div className="absolute bottom-36 right-10 h-3 w-3 bg-teal-400/20 ring-1 ring-teal-300/40 transition-all duration-300 hover:bg-teal-300 hover:shadow-[0_0_12px_rgba(20,184,166,0.8)]" style={{ clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)' }} />
      <div className="absolute top-28 left-1/2 h-3 w-3 -translate-x-1/2 bg-fuchsia-500/20 ring-1 ring-fuchsia-400/40 transition-all duration-300 hover:bg-fuchsia-400 hover:shadow-[0_0_12px_rgba(244,63,94,0.8)]" />
    </div>
  )
}
...
function Navbar() {
  ...
  return (
    <div className="fixed inset-x-0 top-3 z-50 flex justify-center px-3">
      <nav className="relative flex w-full max-w-5xl items-center justify-between gap-2 rounded-2xl border border-pink-500/40 bg-zinc-900/30 px-2 sm:px-3 py-2 shadow-[0_10px_60px_rgba(236,72,153,0.2)] backdrop-blur-xl">
        {/* glowing edges */}
        <div className="pointer-events-none absolute inset-0 rounded-2xl ring-1 ring-pink-400/40 [box-shadow:inset_0_0_30px_rgba(236,72,153,0.25)]" />
        <div className="relative z-10 flex flex-wrap items-center justify-center gap-1 sm:gap-2">
          {items.map(({ id, label, icon: Icon }) => (
            <a
              ...
              className="group inline-flex items-center gap-2 rounded-xl px-2 sm:px-3 py-2 text-xs sm:text-sm font-semibold text-zinc-200/90 transition-colors hover:text-white"
            >
              <span className="rounded-md border border-pink-500/30 sm:border-pink-500/40 bg-pink-500/10 p-1.5 text-pink-300 shadow-[0_0_10px_rgba(236,72,153,0.35)] group-hover:bg-pink-500/20">
                <Icon className="h-4 w-4" />
              </span>
              <span className="drop-shadow-[0_0_8px_rgba(236,72,153,0.3)]">{label}</span>
            </a>
          ))}
        </div>
      </nav>
  ...
  return (
    <section className="relative z-10 mx-auto -mt-2 mb-10 max-w-3xl px-4">
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="relative overflow-hidden rounded-2xl border border-rose-500/40 bg-zinc-950/70 p-5 shadow-[0_0_40px_rgba(244,63,94,0.2)] backdrop-blur-md"
      ...
      >
        ...
        <div className="relative z-10 grid grid-cols-4 gap-2 sm:gap-3 text-center">
          {[{label:'Days', value: days}, {label:'Hours', value: hours}, {label:'Minutes', value: minutes}, {label:'Seconds', value: seconds}].map((it, i) => (
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="rounded-xl border border-rose-400/30 bg-gradient-to-b from-zinc-900/60 to-black/70 p-3 sm:p-4 shadow-[inset_0_0_25px_rgba(244,63,94,0.12)]"
            >
              <div className="text-2xl sm:text-3xl font-extrabold tracking-widest text-rose-300 drop-shadow-[0_0_16px_rgba(244,63,94,0.4)]">
                {String(it.value).padStart(2, '0')}
              </div>
              <div className="mt-1 text-[9px] sm:text-[10px] uppercase tracking-[0.2em] text-rose-200/70">{it.label}</div>
            </motion.div>
          ))}
        </div>
    ...
    <section id="home" className="relative min-h-[90vh] w-full overflow-hidden bg-[#09090b]">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pt-28 pb-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="mt-6 aspect-[16/9] w-full overflow-hidden rounded-2xl border border-fuchsia-500/30 bg-black/40 shadow-[0_0_30px_rgba(236,72,153,0.2)] backdrop-blur-md"
          style={{ perspective: '1200px' }}
        >
  ...
  return (
    ...
    >
      ...
      <div className="relative p-5">
        ...
        {/* Easter egg tiny symbol */}
        <span className="absolute -bottom-1 right-3 h-2 w-2 rounded-full bg-pink-500/20 ring-1 ring-pink-400/40 transition-all duration-300 hover:bg-pink-400 hover:shadow-[0_0_10px_rgba(236,72,153,0.8)]" />
      </div>
    </motion.div>
  )
}
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2">
          <motion.a
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="group relative flex items-center justify-between rounded-2xl border border-pink-500/40 bg-gradient-to-b from-zinc-900 to-black p-6 shadow-[0_0_30px_rgba(236,72,153,0.2)] transition-transform hover:-translate-y-0.5"
            animate={{
              boxShadow: [
          ...
          >
            <div>
              <h4 className="text-2xl font-extrabold tracking-wide text-pink-300 drop-shadow-[0_0_16px_rgba(236,72,153,0.45)]">Get Dataset & Template</h4>
            ...
            <div className="rounded-xl border border-pink-400/50 bg-pink-500/10 p-3 text-pink-300 shadow-[0_0_20px_rgba(236,72,153,0.4)] group-hover:shadow-[0_0_28px_rgba(236,72,153,0.55)]">
              <MoveRight className="h-6 w-6" />
            </div>
            <div className="pointer-events-none absolute inset-0 rounded-2xl ring-1 ring-pink-500/40 [box-shadow:inset_0_0_30px_rgba(236,72,153,0.3)]" />
          </motion.a>
          ...
          <motion.form
            ...
            className="relative rounded-2xl border border-teal-400/40 bg-gradient-to-b from-zinc-900 to-black p-6 shadow-[0_0_30px_rgba(20,184,166,0.2)]"
          >
            <div className="absolute inset-0 rounded-2xl ring-1 ring-teal-400/40 [box-shadow:inset_0_0_30px_rgba(20,184,166,0.25)]" />
            <div className="relative z-10">
              <div className="mb-4 flex items-center gap-3">
                <div className="rounded-lg border border-teal-400/50 bg-teal-400/10 p-2 text-teal-300 shadow-[0_0_16px_rgba(20,184,166,0.4)]">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <input
                  ...
                  className="w-full rounded-md border border-zinc-700/70 bg-zinc-900/70 px-3 py-3 sm:py-2 text-zinc-100 outline-none ring-1 ring-transparent focus:ring-teal-400/60"
                />
                <input
                  type="email"
                ...
                <div className="sm:col-span-2">
                  <input
                    ...
                    className="block w-full cursor-pointer rounded-md border border-zinc-700/70 bg-zinc-900/70 px-3 py-3 sm:py-2 text-zinc-300 file:mr-4 file:rounded-md file:border-0 file:bg-teal-500/20 file:px-4 file:py-2 file:text-teal-200 hover:file:bg-teal-500/30"
                    required
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-4 inline-flex w-full items-center justify-center rounded-md bg-gradient-to-r from-teal-500 to-teal-400 px-4 py-3 sm:py-2 font-semibold text-black shadow-[0_0_24px_rgba(20,184,166,0.35)] transition-transform hover:-translate-y-0.5 disabled:opacity-60"
              >
...
function InitialAvatar({ name }) {
  ...
  return (
    <div className="relative h-20 w-20 overflow-hidden rounded-xl ring-2 ring-pink-500/50 shadow-[0_0_24px_rgba(236,72,153,0.3)]">
...
function TeamMemberCard({ name, role, img, index = 0 }) {
  ...
  return (
    <motion.div
      ...
      className="group relative flex items-center gap-4 rounded-2xl border border-zinc-700/60 bg-gradient-to-b from-zinc-900/70 to-black/70 p-5 hover:border-pink-500/50 hover:shadow-[0_0_30px_rgba(236,72,153,0.2)]"
    >
      {img ? (
      ...
      {/* tiny square Easter egg */}
      <span className="absolute -right-2 -top-2 h-2 w-2 bg-fuchsia-500/20 ring-1 ring-fuchsia-400/40 transition-all duration-300 hover:bg-fuchsia-400 hover:shadow-[0_0_10px_rgba(244,63,94,0.8)]" />
    </motion.div>
  )
}
...
function ParallaxTokens() {
  ...
  return (
    <div ref={ref} aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      <motion.div style={{ y: y1 }} className="absolute left-6 top-10 h-16 w-16 rounded-full bg-pink-500/15 ring-2 ring-pink-500/40 hidden sm:block" />
      <motion.div style={{ y: y2, clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)' }} className="absolute right-10 top-24 h-16 w-16 bg-teal-400/15 ring-2 ring-teal-400/40 hidden sm:block" />
      <motion.div style={{ y: y3 }} className="absolute left-1/2 bottom-10 h-16 w-16 -translate-x-1/2 bg-fuchsia-500/15 ring-2 ring-fuchsia-400/40 hidden sm:block" />
    </div>
  )
}
    ...
    <section className="relative overflow-hidden bg-[radial-gradient(800px_400px_at_50%_-10%,rgba(236,72,153,0.10),transparent),linear-gradient(to_bottom,rgba(0,0,0,0.9),#050505)] py-16">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="my-10 flex items-center justify-center gap-3 opacity-80">
          <span className="h-1 w-24 rounded-full bg-pink-500/60 shadow-[0_0_16px_rgba(236,72,153,0.5)]" />
          ...
          <span className="h-1 w-24 rounded-full bg-teal-400/60 shadow-[0_0_16px_rgba(20,184,166,0.5)]" />
        </div>
...
function AmbientAudioToggle() {
  ...
  useEffect(() => {
    ...
    if (enabled) {
      ...
      if (playPromise?.catch) playPromise.catch(() => {/* ignore autoplay errors until user interacts */})
    } else {
      audio.pause()
    }
  }, [enabled])
  ...
  return (
    <div className="mb-4 flex w-full justify-center">
      <button
        ...
        className={`inline-flex items-center gap-2 rounded-full border px-4 py-2 text-xs font-semibold backdrop-blur ${enabled ? 'border-teal-400/50 bg-teal-400/10 text-teal-200 shadow-[0_0_18px_rgba(20,184,166,0.35)]' : 'border-pink-500/40 bg-pink-500/5 text-pink-200/90 shadow-[0_0_12px_rgba(236,72,153,0.25)]'}`}
      >
        {enabled ? 'Ambient: On' : 'Ambient: Off'}
      </button>
      <audio
        ref={audioRef}
        src="https://cdn.pixabay.com/download/audio/2022/01/20/audio_3a2f9d3f3a.mp3?filename=dark-ambient-dreamscape-9895.mp3"
        loop
        preload="none"
      />
    </div>
...
function NeonFooter() {
  return (
    <footer className="relative border-t border-zinc-800/80 bg-black/80 py-10">
      <div className="pointer-events-none absolute inset-0 rounded-t-[22px] ring-1 ring-pink-500/40 [box-shadow:inset_0_0_40px_rgba(236,72,153,0.28)]" />
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          <div className="text-center sm:text-left">
            <p className="text-sm text-zinc-400">© {new Date().getFullYear()} Vibe Coding — Squid Game Edition</p>
            <a href="mailto:team@vibecoding.gg" className="mt-1 inline-flex items-center gap-2 text-sm text-pink-300 hover:text-pink-200">
              <Mail className="h-4 w-4" /> team@vibecoding.gg
            </a>
          </div>
          <div className="flex items-center gap-3">
            <a href="https://twitter.com/" target="_blank" rel="noreferrer" className="group rounded-lg border border-pink-500/30 bg-pink-500/10 p-2 text-pink-300 shadow-[0_0_14px_rgba(236,72,153,0.35)] hover:bg-pink-500/20">
              <Twitter className="h-5 w-5" />
            </a>
            <a href="https://github.com/" target="_blank" rel="noreferrer" className="group rounded-lg border border-teal-400/30 bg-teal-400/10 p-2 text-teal-300 shadow-[0_0_14px_rgba(20,184,166,0.35)] hover:bg-teal-400/20">
              <Github className="h-5 w-5" />
            </a>
            <a href="#home" className="group rounded-lg border border-fuchsia-400/30 bg-fuchsia-400/10 p-2 text-fuchsia-300 shadow-[0_0_14px_rgba(244,63,94,0.35)] hover:bg-fuchsia-400/20">
